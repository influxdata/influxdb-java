...
public final class Preconditions {
   ...
   */
  public static String checkNonEmptyString(final String string, final String name)
   ...
   */
  public static void checkPositiveNumber(final Number number, final String name)
      throws IllegalArgumentException {
   ...
   * @throws IllegalArgumentException if the number is less or equal to 0
   */
  public static void checkNotNegativeNumber(final Number number, final String name)
      throws IllegalArgumentException {
    if (number == null || number.doubleValue() < 0) {
   ...
   */
  public static void checkDuration(final String duration, final String name)
      throws IllegalArgumentException {
