...
public class CheckTagsTest {
  ...
  public void TagNameSymbolTest() {
    ...
    Point.Builder point1 =
        Point.measurement("test").time(1, TimeUnit.NANOSECONDS).tag(map).addField("a", 1.0);
    ...
    Assert.assertThrows(
        ...
        () -> {
          Point.Builder point =
              Point.measurement("test")
                  .time(1, TimeUnit.NANOSECONDS)
                  .tag(tagname, "whistle while you work")
                  .addField("a", 1.0);
        });
