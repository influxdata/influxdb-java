...
public class BoundParameterQueryTest {
  ...
  public void testGetParameterJsonWithUrlEncoded() throws IOException {
    BoundParameterQuery query =
        QueryBuilder.newQuery(
                "SELECT * FROM abc WHERE integer > $i"
  ...
  public void testEqualsAndHashCode() {
    ...
    Query queryA0 = QueryBuilder.newQuery(stringA0).forDatabase(stringA0).bind("a", 0).create();
    Query queryA1 = QueryBuilder.newQuery(stringA1).forDatabase(stringA1).bind("a", 0).create();
    Query queryA2 = QueryBuilder.newQuery(stringA1).forDatabase(stringA1).bind("a", 10).create();
    Query queryB0 = QueryBuilder.newQuery(stringB0).forDatabase(stringB0).bind("b", 10).create();
